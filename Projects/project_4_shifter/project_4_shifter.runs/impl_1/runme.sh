...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_4_shifter/project_4_shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_8_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shifter_8_bit.tcl -notrace
