...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_4_shifter/project_4_shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_8_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shifter_8_bit.tcl
