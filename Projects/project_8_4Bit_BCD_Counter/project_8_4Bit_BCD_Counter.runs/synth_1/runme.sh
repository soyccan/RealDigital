...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_8_4Bit_BCD_Counter/project_8_4Bit_BCD_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapper_system.tcl
