...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project2_Task2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project2_Task2.tcl
