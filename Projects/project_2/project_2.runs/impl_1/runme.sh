...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project2_Task2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project2_Task2.tcl -notrace
