...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_8_sync_binary_counter/project_8_sync_binary_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_binary_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sync_binary_counter.tcl -notrace
