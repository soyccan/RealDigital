...
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L4N_T0_34 Schematic=BTN1
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk ];
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L24P_T3_34 Schematic=BTN2
