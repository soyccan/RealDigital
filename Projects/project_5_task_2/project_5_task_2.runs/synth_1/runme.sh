...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_5_task_2/project_5_task_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digit_displaying.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digit_displaying.tcl
