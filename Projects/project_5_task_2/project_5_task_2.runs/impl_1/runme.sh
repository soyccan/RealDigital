...
HD_PWD='C:/Users/Chi-cheng Chuang/OneDrive/Classes/Spring 2021/E_E_214/Projects/project_5_task_2/project_5_task_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digit_displaying.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digit_displaying.tcl -notrace
